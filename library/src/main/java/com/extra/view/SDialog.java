...
public class SDialog extends Dialog {
    ...
    public SDialog(Context context, int themeResId) {
        super(context, themeResId);
        initView(context);
    }

    public SDialog(Context context, boolean cancelable, DialogInterface.OnCancelListener cancelListener) {
     ...
     */
    public SDialog(Context context, float alpha, int gravity) {
        super(context);
